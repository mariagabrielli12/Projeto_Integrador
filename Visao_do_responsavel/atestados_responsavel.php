    ...
    <div class="card-body">
        ...
        <div id="novo-atestado" class="tab-content active">
            <form id="form-atestado" method="POST" action="processa_atestado.php" enctype="multipart/form-data">
                ...
                <div class="file-upload-container"><label for="arquivo_atestado" class="file-upload"><input type="file" id="arquivo_atestado" name="arquivo_atestado" accept=".pdf,.jpg,.jpeg,.png" required><span class="file-upload-label"><i class="fas fa-cloud-upload-alt"></i><span>Clique para enviar o atestado</span><p>Formatos: PDF, JPG, PNG</p></span></label><div id="file-info" class="file-info">Nenhum ficheiro selecionado</div></div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.getElementById('arquivo_atestado').addEventListener('change', function() {
            ...
            fileInfo.textContent = this.files.length > 0 ? this.files[0].name : "Nenhum ficheiro selecionado";
        });
    });
</script>
